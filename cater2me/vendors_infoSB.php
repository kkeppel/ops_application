...
$deliverBSR = $_POST['deliverBSR'];
if ($deliverBSR == 1) {$deliverBSRmail = 'yes';}  else {$deliverBSRmail = 'no';}  
$orderminBSR = $_POST['orderminBSR'];
$delfeeBSR  = $_POST['delfeeBSR'];
$typefeeBSR = $_POST['typefeeBSR'];
$delfeemaxBSR  = $_POST['delfeemaxBSR'];

$deliverPM = $_POST['deliverPM'];
if ($deliverPM == 1) {$deliverPMmail = 'yes';}  else {$deliverPMmail = 'no';}  
$orderminPM = $_POST['orderminPM'];
$delfeePM  = $_POST['delfeePM'];
$typefeePM = $_POST['typefeePM'];
$delfeemaxPM  = $_POST['delfeemaxPM'];

$deliverMSC = $_POST['deliverMSC'];
if ($deliverMSC == 1) {$deliverMSCmail = 'yes';}  else {$deliverMSCmail = 'no';}  
$orderminMSC = $_POST['orderminMSC'];
$delfeeMSC  = $_POST['delfeeMSC'];
$typefeeMSC = $_POST['typefeeMSC'];
$delfeemaxMSC  = $_POST['delfeemaxMSC'];

$deliverSJ = $_POST['deliverSJ'];
if ($deliverSJ == 1) {$deliverSJmail = 'yes';}  else {$deliverSJmail = 'no';}  
$orderminSJ = $_POST['orderminSJ'];
$delfeeSJ  = $_POST['delfeeSJ'];
$typefeeSJ = $_POST['typefeeSJ'];
$delfeemaxSJ  = $_POST['delfeemaxSJ'];
...
$sql2 = "UPDATE `vendor_infoSB` SET `vendinfo_delSF`='$deliver',`vendinfo_ordmin`='$orderminSF',`vendinfo_delfee`='$delfee',`vendinfo_delfeemax`='$delfeemax' ,`vendinfo_delNB`='$deliverNB',`vendinfo_ordminNB`='$orderminNB',`vendinfo_delfee`='$delfeeNB',`vendinfo_delfeemax`='$delfeemaxNB' ,`vendinfo_delEB`='$deliverEB',`vendinfo_ordminEB`='$orderminEB',`vendinfo_delfeeEB`='$delfeeEB',`vendinfo_delfeemaxEB`='$delfeemaxEB',`vendinfo_delBSR`='$deliverBSR',`vendinfo_ordminBSR`='$orderminBSR',`vendinfo_delfeeBSR`='$delfeeBSR',`vendinfo_delfeemaxBSR`='$delfeemaxBSR',`vendinfo_delPM`='$deliverPM',`vendinfo_ordminPM`='$orderminPM',`vendinfo_delfeePM`='$delfeePM',`vendinfo_delfeemaxPM`='$delfeemaxPM',`vendinfo_delMSC`='$deliverMSC',`vendinfo_ordminMSC`='$orderminMSC',`vendinfo_delfeeMSC`='$delfeeMSC',`vendinfo_delfeemaxMSC`='$delfeemaxMSC',`vendinfo_delSJ`='$deliverSJ',`vendinfo_ordminSJ`='$orderminSJ',`vendinfo_delfeeSJ`='$delfeeSJ',`vendinfo_delfeemaxSJ`='$delfeemaxSJ',`vendinfo_delcap`='$capacity',`vendinfo_notice`='$notice',`vendinfo_chafdis`='$chafdis',`vendinfo_charge`='$chargedis',`vendinfo_utens`='$utens',`vendinfo_fullserv`='$fullserv',`vendinfo_servcharge`='$servicecharge',`vendinfo_transport`='$transport', `notes`='$notes',`vendinfo_paper`='$paper', `ingredients`='$ingredients' WHERE vendinfo_email = '$email'
";
mysql_query($sql2) or die('SQL error !'.$sql2.'<br>'.mysql_error());

$res = mysql_query("SELECT * FROM vendor_infoSB where vendinfo_email = '$email'");
...
if ($rfname1 != '') {
$sql3 = "INSERT INTO `vendor_info_refSB`(`ref_id`, `fname_ref`, `lname_ref`, `email_ref`, `phone_ref`, `id_vendor_info`) VALUES ('','$rfname1','$rlname1','$remail1','$refphone1','$id')";
mysql_query($sql3) or die('SQL error !'.$sql3.'<br>'.mysql_error());	
}
if ($rfname2 != '') {
$sql3 = "INSERT INTO `vendor_info_refSB`(`ref_id`, `fname_ref`, `lname_ref`, `email_ref`, `phone_ref`, `id_vendor_info`) VALUES ('','$rfname2','$rlname2','$remail2','$refphone2','$id')";
mysql_query($sql3) or die('SQL error !'.$sql3.'<br>'.mysql_error());	
}
if ($rfname3 != '') {
$sql3 = "INSERT INTO `vendor_info_refSB`(`ref_id`, `fname_ref`, `lname_ref`, `email_ref`, `phone_ref`, `id_vendor_info`) VALUES ('','$rfname3','$rlname3','$remail3','$refphone3','$id')";
...
$sql3 = "INSERT INTO `vendor_info_availSB`(`id_vnd_avail`, `type_avail`, `monday`, `tuesday`, `wednesday`, `thursday`, `friday`, `saturday`, `sunday`, `vnd_info_id`) VALUES ('','breakfast','$bmond','$btuesd','$bwedn','$bthurs','$bfrid','$bsat','$bsund','$id')";
mysql_query($sql3) or die('SQL error !'.$sql3sql.'<br>'.mysql_error());	
}	
if ($lmond == '1' or $ltuesd == '1' or $lwedn == '1' or $lthurs == '1' or $lfrid == '1' or $lsat == '1' or $lsund == '1'  ) {
$sql3 = "INSERT INTO `vendor_info_availSB`(`id_vnd_avail`, `type_avail`, `monday`, `tuesday`, `wednesday`, `thursday`, `friday`, `saturday`, `sunday`, `vnd_info_id`) VALUES ('','lunch','$lmond','$ltuesd','$lwedn','$lthurs','$lfrid','$lsat','$lsund','$id')";
mysql_query($sql3) or die('SQL error !'.$sql3sql.'<br>'.mysql_error());	
}	
if ($dmond == '1' or $dtuesd == '1' or $dwedn == '1' or $dthurs == '1' or $dfrid == '1' or $dsat == '1' or $bsund == '1'  ) {
$sql3 = "INSERT INTO `vendor_info_availSB`(`id_vnd_avail`, `type_avail`, `monday`, `tuesday`, `wednesday`, `thursday`, `friday`, `saturday`, `sunday`, `vnd_info_id`) VALUES ('','dinner','$dmond','$dtuesd','$dwedn','$dthurs','$dfrid','$dsat','$dsund','$id')";
mysql_query($sql3) or die('SQL error !'.$sql3sql.'<br>'.mysql_error());	
}
...
$body2.='Delivery to Burlingame / San Mateo / Redwood City: '.$deliverBSRmail.'<br />';
if ($deliverBSRmail=='yes') {
$body2.='Order Mimimum Burlingame / San Mateo / Redwood City: '.$orderminBSR.'<br />';
if ($delfeeBSR!=''){ 
$body2.='Delivery fees for Burlingame / San Mateo / Redwood City: '.$delfeeBSR." ".$typefeeBSR.'<br />
Delivery fee maximum for Burlingame / San Mateo / Redwood City: '.$delfeemaxBSR.'<br />'; }}

$body2.='Delivery to Palo Alto / Menlo Park: '.$deliverPMmail.'<br />';
if ($deliverPMmail=='yes') {
$body2.='Order Mimimum Palo Alto / Menlo Park: '.$orderminPM.'<br />';
if ($delfeePM!=''){ 
$body2.='Delivery fees for Palo Alto / Menlo Park: '.$delfeePM." ".$typefeePM.'<br />
Delivery fee maximum for Palo Alto / Menlo Park: '.$delfeemaxPM.'<br />'; }}

$body2.='Delivery to  Mountain View / Sunnyvale / Santa Clara / Cupertino: '.$deliverMSCmail.'<br />';
if ($deliverMSCmail=='yes') {
$body2.='Order Mimimum  Mountain View / Sunnyvale / Santa Clara / Cupertino: '.$orderminMSC.'<br />';
if ($delfeeMSC!=''){ 
$body2.='Delivery fees for  Mountain View / Sunnyvale / Santa Clara / Cupertino: '.$delfeeMSC." ".$typefeeMSC.'<br />
Delivery fee maximum for  Mountain View / Sunnyvale / Santa Clara / Cupertino: '.$delfeemaxMSC.'<br />'; }}

$body2.='Delivery to San Jose: '.$deliverSJmail.'<br />';
if ($deliverSJmail=='yes') {
$body2.='Order Mimimum San Jose: '.$orderminSJ.'<br />';
if ($delfeeSJ!=''){ 
$body2.='Delivery fees for San Jose: '.$delfeeSJ." ".$typefeeSJ.'<br />
Delivery fee maximum for San Jose: '.$delfeemaxSJ.'<br />'; }}
...
sendMail('pauline@cater2.me','New vendor profile information - South Bay',$body2,true);		
...
function validate2() {
	...
	if(!checkNb(document.getElementById("orderminBSR").value))
	{
	alert("Please indicate a number for order minimum for Burlingame / San Mateo / Redwood City  orders ");
	return false;
	}
	if(!checkNb(document.getElementById("delfeeBSR").value))
	{
	alert("Please indicate a number for delivery fee for the Burlingame / San Mateo / Redwood City ");
	return false;
	}
	if(!checkNb(document.getElementById("delfeemaxBSR").value))
	{
	alert("Please indicate a number for the size of the order above which no delivery fee will be charged for Burlingame / San Mateo / Redwood City  orders ");
	return false;
	}
	if(!checkNb(document.getElementById("orderminPM").value))
	{
	alert("Please indicate a number for order minimum for Palo Alto / Menlo Park orders ");
	return false;
	}
	if(!checkNb(document.getElementById("delfeePM").value))
	{
	alert("Please indicate a number for delivery fee for the Palo Alto / Menlo Park");
	return false;
	}
	if(!checkNb(document.getElementById("delfeemaxPM").value))
	{
	alert("Please indicate a number for the size of the order above which no delivery fee will be charged for Palo Alto / Menlo Park orders ");
	return false;
	}
	if(!checkNb(document.getElementById("orderminMSC").value))
	{
	alert("Please indicate a number for order minimum for Mountain View / Sunnyvale / Santa Clara / Cupertino orders ");
	return false;
	}
	if(!checkNb(document.getElementById("delfeeMSC").value))
	{
	alert("Please indicate a number for delivery fee for the Mountain View / Sunnyvale / Santa Clara / Cupertino");
	return false;
	}
	if(!checkNb(document.getElementById("delfeemaxMSC").value))
	{
	alert("Please indicate a number for the size of the order above which no delivery fee will be charged for Mountain View / Sunnyvale / Santa Clara / Cupertino orders ");
	return false;
	}
	if(!checkNb(document.getElementById("orderminSJ").value))
	{
	alert("Please indicate a number for order minimum for San Jose orders ");
	return false;
	}
	if(!checkNb(document.getElementById("delfeeSJ").value))
	{
	alert("Please indicate a number for delivery fee for the San Jose");
	return false;
	}
	if(!checkNb(document.getElementById("delfeemaxSJ").value))
	{
	alert("Please indicate a number for the size of the order above which no delivery fee will be charged for San Jose orders ");
	return false;
	}
	...
	if(!checkEmail(document.getElementById("remail1").value))
	{
	alert("Please enter a valid e-mail address");
	return false;
	}
	if(!checkEmail(document.getElementById("remail2").value))
	{
	alert("Please enter a valid e-mail address");
	return false;
	}
	if(!checkEmail(document.getElementById("remail3").value))
	{
	alert("Please enter a valid e-mail address");
	return false;
	}
...
function show_divBSR1(id)
{
for (var i = 1; i <= 4; i++) {
if (i == id) {
document.getElementById('divBSR_' + i).style.display = 'block';
} else
{
document.getElementById('divBSR_' + i).style.display = 'none';
}}}

function show_divBSR2(id)
{
for (var i = 1; i <= 4; i++) {
if (i == id) {
document.getElementById('divBSR2_' + i).style.display = 'block';
} else
{
document.getElementById('divBSR2_' + i).style.display = 'none';
}}}

function show_divPM1(id)
{
for (var i = 1; i <= 4; i++) {
if (i == id) {
document.getElementById('divPM_' + i).style.display = 'block';
} else
{
document.getElementById('divPM_' + i).style.display = 'none';
}}}

function show_divPM2(id)
{
for (var i = 1; i <= 4; i++) {
if (i == id) {
document.getElementById('divPM2_' + i).style.display = 'block';
} else
{
document.getElementById('divPM2_' + i).style.display = 'none';
}}}

function show_divSJ1(id)
{
for (var i = 1; i <= 4; i++) {
if (i == id) {
document.getElementById('divSJ_' + i).style.display = 'block';
} else
{
document.getElementById('divSJ_' + i).style.display = 'none';
}}}

function show_divSJ2(id)
{
for (var i = 1; i <= 4; i++) {
if (i == id) {
document.getElementById('divSJ2_' + i).style.display = 'block';
} else
{
document.getElementById('divSJ2_' + i).style.display = 'none';
}}}
function show_divMSC1(id)
{
for (var i = 1; i <= 4; i++) {
if (i == id) {
document.getElementById('divMSC_' + i).style.display = 'block';
} else
{
document.getElementById('divMSC_' + i).style.display = 'none';
}}}

function show_divMSC2(id)
{
for (var i = 1; i <= 4; i++) {
if (i == id) {
document.getElementById('divMSC2_' + i).style.display = 'block';
} else
{
document.getElementById('divMSC2_' + i).style.display = 'none';
}}}
...
<table width="100%">
<tr>
<td width="40%">Do you deliver in San Francisco?</td><td><input type="radio" name="deliverSF" value="1" checked="checked" onclick="show_divSF1(1)" > yes
<input type="radio" name="deliverSF" value="0" checked="checked" onclick="show_divSF1(2)"> no</td>
</tr>
</table>
...
<table width="100%">
<tr>
<td width="40%" class="indent">What is your order minimum for SF orders ($ amount)?</td><td><input type="text" id="orderminSF" name="orderminSF"/></td>
</tr>
<tr> 
...
<table width="100%">
<tr>
<td width="40%" class="indent">What is your order minimum for North Bay orders ($ amount)?</td><td><input type="text" id="orderminNB"  name="orderminNB"/></td>
</tr>
<tr>
...
<table width="100%">
<tr>
<td width="40%" class="indent">What is your order minimum for East Bay orders ($ amount)?</td><td><input type="text" id="orderminSF"  id="orderminSF" name="orderminEB"/></td>
</tr>
<tr>
...
<table width="100%">
<tr><td width="40%" class="indent">What is the delivery fee for East Bay?</td><td><input type="text" id="delfeeEB"  name="delfeeEB" /> <select name = "typefeeEB">
<option>$</option>
<option>%</option>
</select></td>
</tr>
...
<table width="100%">
<tr>
<td width="40%">Do you deliver in Burlingame / San Mateo / Redwood City?</td><td><input type="radio" name="deliverBSR" value="1" onclick="show_divBSR1(1)" > yes
<input type="radio" name="deliverBSR" id="orderminSF" value="0" checked="checked" onclick="show_divBSR1(2)"> no</td>
</tr>
</table>

<div id="divBSR_1" style="display: none">
<table width="100%">
<tr>
<td width="40%" class="indent">What is your order minimum for Burlingame / San Mateo / Redwood City orders ($ amount)?</td><td><input type="text" id="orderminBSR" name="orderminBSR"/></td>
</tr>
<tr>
<td width="40%" class="indent">Do you have a delivery fees for orders in Burlingame / San Mateo / Redwood City</td><td><input type="radio" name="delfeechoiceBSR" value="1" onclick="show_divBSR2(1)" > yes
<input type="radio" name="delfeechoiceBSR"  checked="checked" value="0" onclick="show_divBSR2(2)"> no </td></tr>
</table>

<div id="divBSR2_1" style="display: none">
<table width="100%">
<tr><td width="40%" class="indent">What is the delivery fee for Burlingame / San Mateo / Redwood City?</td><td><input type="text" id="delfeeBSR" name="delfeeBSR" /> <select name = "typefeeBSR">
<option>$</option>
<option>%</option>
</select></td>
</tr>
<tr><td width="40%" class="indent">If the delivery fee is only charged on orders below a certain size (e.g. no delivery fee for orders above $500), enter the size of the order above which no delivery fee will be charged, otherwise leave blank.</td><td><input type="text" name="delfeemaxBSR" id="delfeemaxBSR" placeholder="e.g. $1000"/></td>
</tr>
</table>
</div>

<div id="divBSR2_2" style="display:block"></div>
</table>
</div>
<div id="divBSR_2" style="display: block"></div>

<table width="100%">
<tr>
<td width="40%">Do you deliver in Palo Alto / Menlo Park?</td><td><input type="radio" name="deliverPM" value="1"  onclick="show_divPM1(1)" > yes
<input type="radio" name="deliverPM" value="0" checked="checked"onclick="show_divPM1(2)"> no</td>
</tr>
</table>

<div id="divPM_1" style="display: none">
<table width="100%">
<tr>
<td width="40%" class="indent">What is your order minimum for Palo Alto / Menlo Park orders($ amount)?</td><td><input type="text" id="orderminPM" name="orderminPM"/></td>
</tr>
<tr>
<td width="40%" class="indent">Do you have a delivery fees for orders in Palo Alto / Menlo Park</td><td><input type="radio" name="delfeechoicePM" value="1" onclick="show_divPM2(1)" > yes
<input type="radio" name="delfeechoicePM"  checked="checked" value="0" onclick="show_divPM2(2)"> no </td></tr>
</table>

<div id="divPM2_1" style="display: none">
<table width="100%">
<tr><td width="40%" class="indent">What is the delivery fee for Palo Alto / Menlo Park?</td><td><input type="text" name="delfeePM" /> <select id="typefeePM" name = "typefeePM">
<option>$</option>
<option>%</option>
</select></td>
</tr>
<tr><td width="40%" class="indent">If the delivery fee is only charged on orders below a certain size (e.g. no delivery fee for orders above $500), enter the size of the order above which no delivery fee will be charged, otherwise leave blank.</td><td><input type="text" id="delfeemaxPM" name="delfeemaxPM" placeholder="e.g. $1000"/></td>
</tr>
</table>
</div>

<div id="divPM2_2" style="display:block"></div>
</table>
</div>
<div id="divPM_2" style="display: block"></div>

<table width="100%">
<tr>
<td width="40%">Do you deliver in Mountain View / Sunnyvale / Santa Clara / Cupertino?</td><td><input type="radio" name="deliverMSC" value="1" onclick="show_divMSC1(1)" > yes
<input type="radio" name="deliverMSC" value="0" checked="checked" onclick="show_divMSC1(2)"> no</td>
</tr>
</table>

<div id="divMSC_1" style="display: none">
<table width="100%">
<tr>
<td width="40%" class="indent">What is your order minimum for Mountain View / Sunnyvale / Santa Clara / Cupertino orders($ amount)?</td><td><input type="text" id="orderminPM" name="orderminPM"/></td>
</tr>
<tr>
<td width="40%" class="indent">Do you have a delivery fees for orders in Mountain View / Sunnyvale / Santa Clara / Cupertino</td><td><input type="radio" name="delfeechoicePM" value="1" onclick="show_divMSC2(1)" > yes
<input type="radio" id="delfeechoiceMSC" name="delfeechoiceMSC"  checked="checked" value="0" onclick="show_divMSC2(2)"> no </td></tr>
</table>

<div id="divMSC2_1" style="display: none">
<table width="100%">
<tr><td width="40%" class="indent">What is the delivery fee for Mountain View / Sunnyvale / Santa Clara / Cupertino?</td><td><input type="text" id="delfeeMSC" name="delfeeMSC" /> <select name = "typefeeMSC">
<option>$</option>
<option>%</option>
</select></td>
</tr>
<tr><td width="40%" class="indent">If the delivery fee is only charged on orders below a certain size (e.g. no delivery fee for orders above $500), enter the size of the order above which no delivery fee will be charged, otherwise leave blank.</td><td><input type="text" name="delfeemaxMSC" id="delfeemaxMSC" placeholder="e.g. $1000"/></td>
</tr>
</table>
</div>

<div id="divMSC2_2" style="display:block"></div>
</table>
</div>
<div id="divMSC_2" style="display: block"></div>

<table width="100%">
<tr>
<td width="40%">Do you deliver in San Jose?</td><td><input type="radio" name="deliverSJ" value="1" onclick="show_divSJ1(1)" > yes
<input type="radio" name="deliverSJ" value="0" checked="checked" onclick="show_divSJ1(2)"> no</td>
</tr>
</table>

<div id="divSJ_1" style="display: none">
<table width="100%">
<tr>
<td width="40%" class="indent">What is your order minimum for San Jose orders ($ amount)?</td><td><input type="text" id="orderminSJ" name="orderminSJ"/></td>
</tr>
<tr>
<td width="40%" class="indent">Do you have a delivery fees for orders in San Jose</td><td><input type="radio" name="delfeechoicePM" value="1" onclick="show_divSJ2(1)" > yes
<input type="radio" name="delfeechoiceSJ"  checked="checked" value="0" onclick="show_divSJ2(2)"> no </td></tr>
</table>

<div id="divSJ2_1" style="display: none">
<table width="100%">
<tr><td width="40%" class="indent">What is the delivery fee for San Jose?</td><td><input type="text" id="delfeeSJ" name="delfeeSJ" /> <select name = "typefeeSJ">
<option>$</option>
<option>%</option>
</select></td>
</tr>
<tr><td width="40%" class="indent">If the delivery fee is only charged on orders below a certain size (e.g. no delivery fee for orders above $500), enter the size of the order above which no delivery fee will be charged, otherwise leave blank.</td><td><input type="text" id="delfeemaxSJ" name="delfeemaxSJ" placeholder="e.g. $1000"/></td>
</tr>
</table>
</div>

<div id="divSJ2_2" style="display:block"></div>
</table>
</div>
<div id="divSJ_2" style="display: block"></div>
...
<div id="divmat_2" style="display: bloxk"></div>
<table width="100%">
...
<tr><td></td></tr>
<tr><td colspan="2">By clicking this box, I accept Cater2.me's terms outlined above and <a href="#" onclick="javascript:terms(); return false;">terms of service.</a> *&nbsp;&nbsp;<input type="checkbox" id="btnaccepte" value="valeur" onClick="ValideForm()" /> </td></tr>
<tr><td></td></tr>
</table>
...
&nbsp;&nbsp;
<input type="text" id="" name="zip" placeholder="Postal/Zip Code"/></td>
</tr>
