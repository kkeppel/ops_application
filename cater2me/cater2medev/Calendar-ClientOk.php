...
$employee = $curUser['employee_id'];
	...
	if ($client == '0') 
	{
	$res2 = mysql_query ( "SELECT company_id, version_calendar
	...
	$version = $companyarray['version_calendar'];
	}
	else 
	{
	$res3 = mysql_query ( "SELECT company_id, version_calendar
...
$order1 = $order_id[0];
$res2 = mysql_query("
SELECT menu_name, description, label food_category, quantity, vegetarian, gluten_safe, dairy_safe, nut_safe, egg_safe, soy_safe, contains_honey, contains_shellfish, contains_alcohol, order_proposal_items.notes
