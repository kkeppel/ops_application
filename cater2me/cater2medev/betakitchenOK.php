...
?> <div class="hr-pattern"></div><center><img src="/template/images/twitter-bird.png" width="25px" height="20px"> <span style="font-size: 12px;">Twitter feed: <a href="http://twitter.com/#!/C2meSF" target="_blank"> <?
foreach( $oXML->status as $oStatus )
{
 $datetime = date_create($oStatus->created_at);
 $date = date_format($datetime, $date_format)."\n";
 echo parse(utf8_decode($oStatus->text));?> </a><?
...
Click <a href="/template/Cater2.me's BetaKitchen Press Release (4-5-12).pdf" target="_blank">here</a> to download more information about BetaKitchen or <a href="/template/BetaKitchen Press Kit.zip">here</a> for a zip file containing BetaKitchen logos
</span>
</td>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<!-- <a  href="#" onclick="$('<div></div>').dialog({ width: 600 , position: 'center' ,modal: true,autoLoad : true}).load('/menu_popup.php?pop= $id_popup1;');"> -->
<span style="font-size: 12px;"> Menu coming soon </span></a> 
  <br>  <br>
