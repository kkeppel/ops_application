...
/*-----------------------------------------------------------------------------------*/
				if (jQuery().slides) {
					setTimeout("startIndexSliders()",3200);
				}
...
/*-----------------------------------------------------------------------------------*/	
    ...
    if(jQuery(".current a").length) { //c2me, in case menu not selected through server-side framework
    $magicLine
        ...
        .data("origColor", jQuery(".current").attr("rel"));
    }
