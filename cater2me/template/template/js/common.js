...
function vendorConfirmCancel(id_order,hash) {
	Ajax("/dashboard/cancel/?oid="+id_order+"&hash="+hash+"&ajax=1","","vendorConfirmCancel2");
	
	$("#divLnkConfirm"+id_order).click(function() { 1; });
	getID("divLnkConfirm"+id_order).innerHTML="Thank you for confirming.";
}
function vendorConfirmCancel2(source) {
	if(source=="ok")
	{
	}
	else
