...
function of_sanitize_textarea($input) {
	global $allowedtags;
	// changed santization level to allow for HTML inputs
	// https://github.com/devinsays/options-framework-plugin/issues/16
...
function of_sanitize_typography( $input ) {
	...
	$output['face']  = apply_filters( 'of_font_face', $output['face'] ); // Changed filter to allow commas and other font-family requirements
