...
add_action( 'widgets_init', 'jg_ad125x125' );

// Register widget
function jg_ad125x125() {
	register_widget( 'jg_Ad_Widget' );
}

// Widget class
class jg_ad_widget extends WP_Widget {
...
function jg_Ad_Widget() {

	// Widget settings
	$widget_ops = array (
		'classname' => 'jg_ad125x125_widget',
		'description' => __('Displays 125x125 ads blocks.', 'Bowtie')
	);
	...
	$control_ops = array (
		'width' => 300,
		'height' => 350,
		'id_base' => 'jg_ad_widget'
	);

	// Create the widget
	$this->WP_Widget( 'jg_ad_widget', __('Bowtie 125x125 Ads', 'Bowtie'), $widget_ops, $control_ops );
...
function form( $instance ) {
	...
	$defaults = array(
		'title' => 'Our Sponsors',
		'ad1' => get_template_directory_uri()."/images/ad125x125.jpg",
		'link1' => 'http://themeforest.net/user/JamiGibbs/profile',
		'ad2' => get_template_directory_uri()."/images/ad125x125.jpg",
		'link2' => 'http://themeforest.net/user/JamiGibbs/profile',
		'ad3' => '',
		'link3' => '',
		'ad4' => '',
		'link4' => '',
	...
	<p>
		<label for="<?php echo $this->get_field_id( 'ad1' ); ?>"><?php _e('Ad 1 image url:', 'Bowtie') ?></label>
	...
	<p>
		<label for="<?php echo $this->get_field_id( 'link1' ); ?>"><?php _e('Ad 1 link url:', 'Bowtie') ?></label>
	...
	<p>
		<label for="<?php echo $this->get_field_id( 'ad2' ); ?>"><?php _e('Ad 2 image url:', 'Bowtie') ?></label>
	...
	<p>
		<label for="<?php echo $this->get_field_id( 'link2' ); ?>"><?php _e('Ad 2 link url:', 'Bowtie') ?></label>
	...
	<p>
		<label for="<?php echo $this->get_field_id( 'ad3' ); ?>"><?php _e('Ad 3 image url:', 'Bowtie') ?></label>
	...
	<p>
		<label for="<?php echo $this->get_field_id( 'link3' ); ?>"><?php _e('Ad 3 link url:', 'Bowtie') ?></label>
	...
	<p>
		<label for="<?php echo $this->get_field_id( 'ad4' ); ?>"><?php _e('Ad 4 image url:', 'Bowtie') ?></label>
	...
	<p>
		<label for="<?php echo $this->get_field_id( 'link4' ); ?>"><?php _e('Ad 4 link url:', 'Bowtie') ?></label>
	...
	<p>
		<label for="<?php echo $this->get_field_id( 'ad5' ); ?>"><?php _e('Ad 5 image url:', 'Bowtie') ?></label>
	...
	<p>
		<label for="<?php echo $this->get_field_id( 'link5' ); ?>"><?php _e('Ad 5 link url:', 'Bowtie') ?></label>
	...
	<p>
		<label for="<?php echo $this->get_field_id( 'ad6' ); ?>"><?php _e('Ad 6 image url:', 'Bowtie') ?></label>
	...
	<p>
		<label for="<?php echo $this->get_field_id( 'link6' ); ?>"><?php _e('Ad 6 link url:', 'Bowtie') ?></label>
	...
	<!-- Randomize? -->
	<p>
		<label for="<?php echo $this->get_field_id( 'random' ); ?>"><?php _e('Randomize order of ads?', 'Bowtie') ?></label>
