...
/*  Flickr Widget
/*-----------------------------------------------------------------------------------*/
class jg_flickr extends WP_Widget {
	function jg_flickr() {
		$widget_ops = array('classname' => 'jg_flickr', 'description' => 'Display your recent Flickr photos' );
		$this->WP_Widget('jg_flickr', 'Bowtie Flickr', $widget_ops);
	}
	...
	function widget($args, $instance) {
		...
		if(!empty($items) && !empty($flickr_id))
		{
			...
			if(!empty($photos_arr))
			{
				...
				{
					echo '<li>';
					echo '<a href="'.$photo['url'].'" title="'.$photo['title'].'"><img src="'.$photo['thumb_url'].'" alt="" width="60" height="60"/></a>';
					echo '</li>';
				}
