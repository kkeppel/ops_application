<?php
	...
	var $pluginname = 'jgshortcodepanel';
	var $path = '';
	...
	function add_shortcode_button()  
	{
		...
		$this->path = get_template_directory_uri() . '/includes/shortcodes/tinymce/';	
	...
	function add_tinymce_langs_path($plugin_array) 
	{
		...
		$plugin_array[$this->pluginname] = get_template_directory_uri() . '/includes/shortcodes/tinymce/langs.php';
		return $plugin_array;
	}
