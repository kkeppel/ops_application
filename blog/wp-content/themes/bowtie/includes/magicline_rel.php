...
/*-----------------------------------------------------------------------------------*/	
    ...
    $magicLine
        ...
        .data("origColor", jQuery(".current-menu-item, .current-menu-parent, .current_page_ancestor, .current-menu-ancestor, .current_page_item").find(">a").attr("rel"));
    });  /* update */  
    jQuery("#main-nav>li").hover(function() {
        ...
        $magicLine.stop().animate({
            left: leftPos,
            width: newWidth,
            backgroundColor: $el.find(">a").attr("rel")
        })
    }, function() {
        $magicLine.stop().animate({
