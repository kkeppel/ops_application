	...
	<div class="inner-cta-wrap">
		<div id="call-to-action" class="container_12">
			...
			<div id="cta-top" class="grid_12">
				<h2 class="inner-title"><?php _e('Search Results for','bowtie'); ?> '<?php the_search_query(); ?>' </h2>
	...
	<div class="container_12" id="body-wrap" role="main">
		...
		<div id="post-content-wrap" class="grid_7 suffix_1">
			...
			<div class="featured-image image-fade omega">
				...
				<a class="portfolio" href="<?php echo $blog_image_url[0]; ?>">
					...
					<div class="content">
						...
						<?php the_excerpt(__('read more &rarr;', 'bowtie')); ?>
			...
			<div class="pagination wp-pagenavi">
				...
				<div class="nav-next"><?php next_posts_link(__('&larr; Older Entries', 'bowtie')) ?></div>
				<div class="nav-previous"><?php previous_posts_link(__('Newer Entries &rarr;', 'bowtie')) ?></div>
				<?php } ?>
			</div>
