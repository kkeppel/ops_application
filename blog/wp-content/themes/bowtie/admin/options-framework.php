...
function optionsframework_add_page() {
	...
	$of_page = add_submenu_page('themes.php', __('Theme Options','bowtie'), __('Theme Options','bowtie'), 'edit_theme_options', 'options-framework','optionsframework_page');
...
function optionsframework_page() {
	...
	// Get the theme version so we can display it up top
    ...
    <div id="of_container">
	  ...
	  <?php settings_fields('optionsframework'); ?>
        ...
        <div id="header">
          <div class="logo">
            <h2><?php esc_html_e( $themename ); ?><span style="font-size:14px;">&nbsp; &nbsp; v <?php esc_html_e( $themeversion ); ?></span></h2>
          </div>
          <div class="clear"></div>
        </div>
        <div id="main">
