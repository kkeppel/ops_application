...
(function($) {
	...
	// Default Options
	$.fn.tuw.defaults = {
		'username' : ['jamigibbs'],		// [string] Username of the tweep. Write multiple accounts in this format : ['username_1','username_2','username_3']
	...
	$.fn.tuw.structureAdvanced = '<div class="tuw_twi"><div class="tuw_head"><a class="tuw_av_a"><div class="twitter-bird"></div></a></div><div class="tuw_contentbox"><div class="tuw_content"><div class="tuw_t"><div class="tuw_r tuw_updatetext"></div><div class="tuw_clear"></div></div><div class="tuw_b"><div class="tuw_l tuw_timetext"></div></div><br /><div class="tuw_b"><div class="tuw_r tuw_buttons"><a href="javascript:;" class="tuw_next tuw_dis"></a><a href="javascript:;" class="tuw_prev tuw_dis"></a></div><div class="tuw_clear"></div></div></div></div></div>';
