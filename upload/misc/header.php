	...
	<div class="container_12" id="header" >
		...
		<header>
			...
			<a href="/">
				...
				<div id="divAccount">
				<? if($curUser) { ?>
					Hi, <?=$curUser['first_name']?>. <a href="/logout/">Sign out</a>
				<? } else { ?>
			...
			<nav id="top_nav" class="grid_8">
				...
				?>
					...
					<li rel="#e7e7e7"<? if($template['menu_selected']=='event-spotlight') echo ' class="current"'; ?>>
						<a href="/event-spotlight/">Events</a> 
					</li>
				...
				if($curUser) {
					...
					<div id="globalSignup" style="height:114px">
						...
						<div id="globalSignupRight">
							<div class="label" style="line-height:45px;font-size:14px"><span style="color: black;">Refer a friend and you'll both get $50 when they order.</span></div>							
						...
						<div id="globalSignup">
							...
							<div id="globalSignupRight">
								<div class="label"><span style="color: black;">Refer a friend and you'll both get $50 when they order.</span></div>
								<div style="float:left">
...
?>
                            <input type="hidden" id="cookie_track" value="<? echo $aux->first_visit ?>">
							</div>
							<div style="float:left">
							<input type="button" id="btnSignup_email" value="" onClick="sendSignup(); _gaq.push(['_trackEvent', 'form', 'email']);" />
							</div>
