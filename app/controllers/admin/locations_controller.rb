class Admin::LocationsController < ApplicationController
  ...
  def create
	  ...
	  respond_to do |format|
		  if @location.save
			  format.html {
				  redirect_to params[:company_id] ? admin_company_locations_path(@company) : admin_vendor_locations_path(@vendor),
  ...
  def destroy
	  ...
	  respond_to do |format|
		  format.html { redirect_to params[:company_id] ? admin_company_locations_path(@company) : admin_vendor_locations_path(@vendor)}
		  format.json { head :no_content }
	  end
  end
