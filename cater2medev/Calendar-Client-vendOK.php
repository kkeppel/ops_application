...
?>
<style type="text/css">
/*AJOUTER PLUS HAUT PR NEW JQUERY  <link rel="stylesheet" href="/template/css/custom/jquery-ui-1.8.18.calendar.css" /> */
...
<div class="accordion">
	...
	<? $lastCategory1='-';
	$description1.='<a href="http://cater2.me/dashboard/feedback/?oid='.$order1.'" target="_blank">'.$name_vndtb[0].' Feedback</a>'."<br>";
...
<div class="accordion">
	...
	<? $lastCategory2='-';
	$description2.='<a href="http://cater2.me/dashboard/feedback/?oid='.$order2.'" target="_blank">'.$name_vndtb[1].' Feedback</a>'."<br>";
while($item = mysql_fetch_assoc($res2))
{
		$veg = '';
		$glu= '';
...
<div class="accordion">
	...
	<? $lastCategory3='-';
	$description3.='<a href="http://cater2.me/dashboard/feedback/?oid='.$order3.'" target="_blank">'.$name_vndtb[2].' Feedback</a>'."<br>";
while($item = mysql_fetch_assoc($res2))
{
		$veg = '';
		$glu= '';
...
<div class="accordion">
	...
	<? $lastCategory4='-';
	$description4.='<a href="http://cater2.me/dashboard/feedback/?oid='.$order4.'" target="_blank">'.$name_vndtb[3].' Feedback</a>'."<br>";
while($item = mysql_fetch_assoc($res2))
{
		$veg = '';
		$glu= '';
...
<div class="accordion">
	...
	<? $lastCategory5='-';
	$description5.='<a href="http://cater2.me/dashboard/feedback/?oid='.$order5.'" target="_blank">'.$name_vndtb[4].' Feedback</a>'."<br>";
while($item = mysql_fetch_assoc($res2))
{
		$veg = '';
		$glu= '';
